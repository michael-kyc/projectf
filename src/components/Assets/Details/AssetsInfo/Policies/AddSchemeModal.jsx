  ...
  return (
    <>
      <Modal
        ...
        customWidth="w-11/12 md:w-3/4 xl:w-6/12"
          ...
          <div className="flex flex-col items-center w-full gap-2 md:flex-row">
            <div className="w-full">
              ...
              <DropDown
                ...
                items={[
                  {
                    value: FEE_SCHEME_ACTIVITY["Select asset type"],
              ...
              <div>
                <div className="w-full">
                  <DropDown
                    ...
                    defaultValue={
                      formData && formData.gasPrice
                        ? {
                            value: formData.gasPrice,
                            label: `${formData.gasPrice} Gwei`,
                          }
                        : undefined
                    }
                    items={[
                      { value: 10, label: "10 Gwei" },
