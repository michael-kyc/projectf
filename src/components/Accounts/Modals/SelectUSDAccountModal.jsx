...
const SelectUSDAccountModal = ({ isModalOpen, closeModal, setSelectedAccount }) => {
  ...
  return (
    <Modal isOpen={isModalOpen} onClose={closeModal} title="Select USD Account" size="lg">
      <div className="p-4">
        {/* Search Input */}
        ...
        >
          ...
          <span className="text-xs font-semibold">Add new USD account</span>
        </div>
      </div>
    </Modal>
  );
...
export default SelectUSDAccountModal;
