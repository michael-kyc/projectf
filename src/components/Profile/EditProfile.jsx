...
const EditProfile = ({ formData, setFormData, showCombinedCard = true }) => {
          ...
          <div className="p-4 bg-white rounded-2xl">
            ...
            <div className="flex flex-col items-center justify-center w-full h-[128px] bg-gray-50 p-4 text-center border-[1px] border-gray-300 border-dashed rounded-2xl">
              ...
              <div className="mt-2">
                <label
                  htmlFor="upload"
                  className="px-4 py-1.5 bg-white text-xs  text-black border border-primary50 rounded-[10px] cursor-pointer font-inter"
                >
            ...
            <CombinedCard
              ...
              dropdownComponent={
                <DropDown
                  ...
                  className="w-full px-3 py-2.5 mt-1 border rounded-[10px] h-[32px] border-gray-300 text-xs"
                />
              }
              dropdownRole={
                <DropDown
