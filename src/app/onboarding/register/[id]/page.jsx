          ...
          <div className="max-w-96">
            ...
            {!authenticator ? (
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="flex flex-col gap-4">
                  <div className="items-center">
                    <div className="text-2xl font-bold">Authentication App</div>
                    <div className="flex flex-row justify-start">
                      <h2 className="text-md text-base text-textSecondary">
                  ...
                  <p className="text-md text-base text-textSecondary">
                    If scanning does not work please copy the below code to add
                    it manually to your authenticator app
                  </p>
